      ...
      <div className="mx-auto grid h-24 max-w-6xl grid-cols-[auto_1fr_auto] items-center gap-6 px-5 md:px-20">
        ...
        <nav className="hidden justify-center md:flex">
          ...
          >
            ...
            >
              {NAV_ITEMS.map((item) => {
                const isHomeItem = item.href === "/#top";
                const isHomeActive = isHomeItem && pathname === "/";
                return (
                <Link
                  key={item.href}
                  href={item.href}
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          <Link
            href="/contact-us"
            className={[
              "hidden md:flex items-center rounded-[54px] px-5 py-3 text-sm font-semibold transition",
              isContactActive
